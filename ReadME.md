...
-   [License](#License)
## Description
This is a Platform for Specialist Doctors to showcasing their services and enable patients to book appointment with any Doctor of their choice
## Installation
### Requirements
...
```
git clone https://github.com/danielngetich/specialist-doctor-website.git
```
If you are using SSH, use the following command
```
git clone git@github.com:danielngetich/specialist-doctor-website.git
```
